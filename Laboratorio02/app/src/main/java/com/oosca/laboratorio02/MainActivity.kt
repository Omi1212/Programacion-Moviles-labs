package com.oosca.laboratorio02
...
class MainActivity : AppCompatActivity() {
    ...
    private fun setListener(){
        actionCalculate.setOnClickListener{
            ...
            val bmi = bmi_cal(height.toFloat(),weight.toFloat())
            val bmiTwoDigits = String.format("%.2f", bmi)


            result(bmiTwoDigits.toFloat())
        }
    }

    private fun bmi_cal(height: Float, weight: Float): Float{
